...
/* Write command */
#define SSD1306_WRITECOMMAND(command)      ssd1306_I2C_Write(SSD1306_I2C_ADDR<<1, 0x00, (command))
/* Write data */
#define SSD1306_WRITEDATA(data)            ssd1306_I2C_Write(SSD1306_I2C_ADDR<<1, 0x40, (data))
/* Absolute value */
...
uint8_t SSD1306_Init(void) {
	...
	if (HAL_I2C_IsDeviceReady(&hi2c1, SSD1306_I2C_ADDR<<1, 1, 20000) != HAL_OK) {
		/* Return false */
		return 0;
	}
...
void SSD1306_UpdateScreen(void) {
	...
	for (m = 0; m < 8; m++) {
		...
		/* Write multi data */
		ssd1306_I2C_WriteMulti(SSD1306_I2C_ADDR<<1, 0x40, &SSD1306_Buffer[SSD1306_WIDTH * m], SSD1306_WIDTH);
	}
}
